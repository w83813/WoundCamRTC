...
public class UVCCamera {
    ...
    private static final String TAG = UVCCamera.class.getSimpleName() + ".uvc";
    private static final String DEFAULT_USBFS = "/dev/bus/usb";

    public static final int DEFAULT_PREVIEW_WIDTH = 160;
    public static final int DEFAULT_PREVIEW_HEIGHT = 120;
    public static final int DEFAULT_PREVIEW_MODE = 11;
    public static final int DEFAULT_PREVIEW_MIN_FPS = 1;
    public static final int DEFAULT_PREVIEW_MAX_FPS = 9;
    public static final float DEFAULT_BANDWIDTH = 0.6f;
    ...
    public static final int PIXEL_FORMAT_Y16 = 11; //kernoli process Y16
    ...
    protected List<Size> mCurrentSizeList = null;
    ...
    public synchronized void stopPreview() {
        try {
            if (mStartStopSemaphore != null) {
                synchronized (mStartStopSemaphore) {
                    if (mStartStopSemaphore.tryAcquire(1, TimeUnit.SECONDS)) {
                        // kernoli, dont setFrameCallback 0 before nativeStopPreview
