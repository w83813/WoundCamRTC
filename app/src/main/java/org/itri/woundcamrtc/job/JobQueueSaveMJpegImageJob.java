...
JobQueueSaveMJpegImageJob extends Job {
    private final String TAG = getClass().getSimpleName();
    private JobManager jobQueueManager = null;
    private MainActivity activity;
    private String distance = "0.0";

    public JobQueueSaveMJpegImageJob(JobManager jobQueueManager, MainActivity activity, String distance) {

        super(new Params(Thread.NORM_PRIORITY + 1).groupBy("saveJob"));
        //super(new Params(Thread.NORM_PRIORITY + 1).groupBy("saveHeatImageJob"));
...
//            }
            ...
            if (connection.getResponseCode() == 200) {
                ...
                //新增熱感影像檔案名稱
                int heatImageCount = 100 + activity.count;
