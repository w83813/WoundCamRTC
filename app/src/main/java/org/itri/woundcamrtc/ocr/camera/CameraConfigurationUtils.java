...
public final class CameraConfigurationUtils {
    ...
    public static  int MAX_PREVIEW_PIXELS = 1290 * 730; // normal screen
    public static  int MIN_PREVIEW_PIXELS = 1270 * 710; // normal screen
...
//        int maxResolution = 0;
        ...
        for (Camera.Size size : rawSupportedSizes) {
            ...
            if (resolution > MAX_PREVIEW_PIXELS) {
                continue;
            }
...
//            }
    ...
    public static Point getPreviewSize(Camera.Parameters parameters) {
        Camera.Size defaultPreview = parameters.getPreviewSize();
