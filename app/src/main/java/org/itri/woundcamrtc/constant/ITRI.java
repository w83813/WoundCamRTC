...
public class ITRI {
    //服科中心       ITRI
    public static final String CONSTANT_APP = "ITRI";
    public static final String CONSTANT_ZONE = "TC";
    public static final String CONSTANT_PROJECT_PATH = "wgnursing";
    public static final String CONSTANT_SERVER_IP = "192.168.1.157"; //記得 preferences.xml也要改
    public static final String CONSTANT_SERVER_IP_PORT = "http://" + CONSTANT_SERVER_IP + ":8080";
    public static final String CONSTANT_AI_SERVER_IP_PORT = "http://140.96.170.74:8007";
