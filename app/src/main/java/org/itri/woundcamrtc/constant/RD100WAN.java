...
public class RD100WAN {
    ...
    public static final String CONSTANT_LOGIN_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/connect/v3/api/authlogin?location=" + CONSTANT_ZONE;
