...
public class TPECH {
    //北巿聯醫   TPECH
    public static final String CONSTANT_APP = "TPECH";
    public static final String CONSTANT_ZONE = "TPECH";
    public static final String CONSTANT_PROJECT_PATH = "woundcare";
    public static final String CONSTANT_SERVER_IP = "192.168.1.115"; //記得 preferences.xml也要改
    public static final String CONSTANT_SERVER_IP_PORT = "http://192.168.1.115:8080";
    public static final String CONSTANT_AI_SERVER_IP_PORT = "http://192.168.1.115:8007";
    ...
    public static final String CONSTANT_LOGIN_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/device/authlogin?location=" + CONSTANT_ZONE;
    public static final String CONSTANT_UPDATE_PASS_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/device/resetPassword?location=" + CONSTANT_ZONE;
    public static final String CONSTANT_QRY_PATIENTINFO_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/wound/tsgh/v2/api/qryPatientInfoByApp?location=" + CONSTANT_ZONE;
    public static final String CONSTANT_UPLOAD_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/wound/tsgh/v2/api/repository/uploadPhoto?location=" + CONSTANT_ZONE;;
    public static final String CONSTANT_QRY_DATE_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/wound/tsgh/v2/api/qryApp?location=" + CONSTANT_ZONE;
    public static final String CONSTANT_QRY_RECORD_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/wound/tsgh/v2/api/qryWoundRecordByDate?location=" + CONSTANT_ZONE;
    public static final String CONSTANT_QRY_PATIENTNOLIST_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/wound/tsgh/v2/api/qrySimilarPatientNo?location=" + CONSTANT_ZONE;
