...
public class ITRIv2IMAS {
    //服科中心       ITRI
    public static final String CONSTANT_APP = "ITRI";
    public static final String CONSTANT_ZONE = "ITRI";
    public static final String CONSTANT_PROJECT_PATH = "wgnursing";
    public static final String CONSTANT_SERVER_IP = "192.168.1.157"; //記得 preferences.xml也要改192.168.50.12
    ...
    public static final String CONSTANT_LOGIN_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/device/authlogin";
    ...
    public static final String CONSTANT_UPLOAD_PATH = CONSTANT_SERVER_IP_PORT + "/" + CONSTANT_PROJECT_PATH + "/wound/tsgh/v2/api/repository/uploadWoundPhoto";
    ...
    public static final boolean CONSTANT_IS_FOR_IMAS_BOX = true;
