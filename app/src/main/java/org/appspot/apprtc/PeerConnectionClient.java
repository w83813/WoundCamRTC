...
public class PeerConnectionClient {
    ...
    public VideoSink localProcess = null;
    @Nullable
    ...
    public PeerConnectionClient(Context appContext, EglBase eglBase,
                                PeerConnectionParameters peerConnectionParameters, PeerConnectionEvents events, VideoCapturer videoCapturer) {
    ...
    public void createPeerConnectionInternal() {
        ...
        if (isVideoCallEnabled()) {
            ...
            if (remoteVideoTrack != null && remoteSinks != null) {
...
//    peerConnection.addTrack(createAudioTrack(), mediaStreamLabels);
    ...
    public void stopVideoSource() {
        startOrStopVideoSource(false);
    }

    public void startVideoSource() {
        startOrStopVideoSource(true);
    }

    public synchronized void startOrStopVideoSource(boolean start) {
        if (!start) {
            //executor.execute(() -> {
    ...
    public void setVideoBitrate(@Nullable final Integer minBitrateKbps, @Nullable final Integer maxBitrateKbps) {
        //executor.execute(() -> {
        if (peerConnection == null || localVideoSender == null || isError) {
            return;
        }
        Log.d(TAG, "Requested video bitrate: " + minBitrateKbps + "~ " + maxBitrateKbps);
        if (localVideoSender == null) {
            Log.w(TAG, "Sender is not ready.");
            return;
        }
        ...
        Log.d(TAG, "Configured video bitrate to: " + minBitrateKbps + "~ " + maxBitrateKbps);
        //});
    }
    ...
    public AudioTrack createAudioTrack() {
        ...
        localAudioTrack.setVolume(65535);
        localAudioTrack.setEnabled(enableAudio);
    ...
    public VideoTrack createVideoTrack(VideoCapturer capturer) {
        surfaceTextureHelper =
                SurfaceTextureHelper.create("mCaptureThread", rootEglBase.getEglBaseContext());
        ...
        if (localProcess != null)
            localVideoTrack.addSink(localProcess);
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        public void onIceCandidatesRemoved(final IceCandidate[] candidates) {
            Log.d(TAG2, "onIceCandidatesRemoved");
            executor.execute(() -> events.onIceCandidatesRemoved(candidates));
        }

        @Override
        public void onSignalingChange(PeerConnection.SignalingState newState) {
            Log.d(TAG2, "SignalingState: " + newState);
        }

        @Override
        public void onIceConnectionChange(final PeerConnection.IceConnectionState newState) {
            //executor.execute(() -> {
            Log.d(TAG2, "IceConnectionState: " + newState);
        ...
        public void onConnectionChange(final PeerConnection.PeerConnectionState newState) {
            //executor.execute(() -> {
            Log.d(TAG2, "PeerConnectionState: " + newState);
        ...
        public void onIceGatheringChange(PeerConnection.IceGatheringState newState) {
            Log.d(TAG2, "IceGatheringState: " + newState);
        }

        @Override
        public void onIceConnectionReceivingChange(boolean receiving) {
            Log.d(TAG2, "IceConnectionReceiving changed to " + receiving);
        }

        @Override
        public void onAddStream(final MediaStream stream) {
            Log.d(TAG2, "onAddStream");
        }

        @Override
        public void onRemoveStream(final MediaStream stream) {
            Log.d(TAG2, "onRemoveStream");
        }

        @Override
        public void onDataChannel(final DataChannel dc) {
            Log.d(TAG2, "New Data channel " + dc.label());
