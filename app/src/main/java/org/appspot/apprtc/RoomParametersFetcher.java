...
public class RoomParametersFetcher {
    ...
    public void makeRequest() {
        ...
        AsyncHttpURLConnection httpConnection =
                new AsyncHttpURLConnection("POST", roomUrl+"?asc=ISAC/16000&arc=opus/48000&audio=googEchoCancellation=true&audio=googEchoCancellation=false", roomMessage, new AsyncHttpEvents() {
                    @Override
