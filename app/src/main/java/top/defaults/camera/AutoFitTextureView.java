...
public class AutoFitTextureView extends TextureView {
    ...
    public void configureFillTransform(int srcWidth, int srcHeight, int dstWidth,int dstHeight) {
        Matrix matrix = new Matrix();
            final int width = getWidth();
            final int height = getHeight();
            // Rotate the camera preview when the screen is landscape.
            matrix.setPolyToPoly(
                    new float[]{
                            0.f, 0.f, // top left
                            srcWidth, 0.f, // top right
                            0.f, srcHeight, // bottom left
                            srcWidth, srcHeight, // bottom right
                    }, 0,
                    new float[]{
                            0.f, 0.f, // top left
                            dstWidth, 0.f, // top right
                            0.f, dstHeight, // bottom left
    ...
    public void configureClearTransform() {
        setTransform(null);
    }
