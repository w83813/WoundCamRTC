...
public class AnyVersion {
    ...
    private AnyVersion(Application context, final VersionParser parser) {
        ...
        this.mainHandler = new Handler(Looper.getMainLooper()){
            @Override public void handleMessage(Message msg) {
                ...
                new VersionDialog(AnyVersion.this.context, version, AnyVersion.this.downloads, downloadingCallback).show();
            }
        };
    ...
    // kernoli
    public void setDownloadingCallback(DownloadingCallback callback){
        //Preconditions.requireInited();
        if (callback == null){
            throw new NullPointerException("Callback CANNOT be null !");
        }
